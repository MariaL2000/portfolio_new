...
export const socialIcons = [
    {
      id: "gmail",
      viewBox: "0 0 24 24",
      url: "mariamarreromedrano@gmail.com",
  ...
  export const experience = [
    {
      ...
      year: "2022 - Present",
      descripcion: "Collaborating with businesses to build innovative web solutions.",
      icon: './UCI2.webp',
    },
  ];
  ...
  export const education = [
    {
      ...
      year: "2021 - Present",
      details: "Currently studying software engineering and obtained an English B2 certification.",
      icon: './UCI.webp',
    },
  ];
  ...
  export const projects = [
    {
      id: 1,
      title: "The Gym Way",
      descripcion: "This is a minimalist site that efficiently and visually summarizes the most important exersices, which given University local situation can be perfomed by students in order to grow the fit community",
      url:"https://thegymway.netlify.app/",
      
      stack: ["React", "Vite" ,"TailwindCSS","Framer Motion","Mui Material", "React-Icons"],
...

    {
      id: 2,
      title: "ProteoSearch",
      descripcion: "ProteoSearch is an advanced web-based platform designed for the interactive visualization and analysis of biomolecular structures. Leveraging real-time 3D rendering, it enables users to explore protein structures in detail, providing an intuitive interface for scientific analysis.",
      url:"https://marial2000.github.io/ProteinVisual/",
      
      stack: ["React", "Vite" ,"TailwindCSS","Canvas, NCBI, UNIPROT API's", "React-Icons"],
    ...
    
    {
      id: 3,
      title: "Harmony Shop",
      descripcion: "Headphones shop made with beautiful animations and a Hero made with Spline, the products are aleatory , it is just a frontend example of econmerce introducing products.",
      url:"https://headphone-harmony.netlify.app/",
      
      stack: ["React", "Vite" ,"TailwindCSS","Spline", "Lucide React", "Gsap","React Mouse Follower", "React intersection observer"],
...

    {
      ...
      descripcion: "Elite-custom is a modern React + TypeScript web project designed for dynamic, responsive interfaces. It features smooth animations, interactive carousels, and accessible UI components, making it ideal for corporate sites or portfolios. The project emphasizes modularity, scalability, and a fast development workflow using Vite..",
      url:  "https://marial2000.github.io/Elite-custom/",
      stack: ["React", "TailwindCSS","Typescript", "Framer Motion","Radix UI" ,"Lucide React","React Hook Form", "Zod","Axios"],
      imageUrl: "/img/project2.png",
    },
    {
      id: 5,
      title: "CRYSPR System",
      descripcion: "A bioinformatics application made with Flask (Python) whose objective is to consult genomic data is a brief database in json format, the idea is that the user enters sequences of nitrogenous DNA bases and they are searched in the standard database and in another that contains possible DNA strands that present repairable mutations using the CRISPR Cas9 system. ",
...

    {
      ...
      descripcion: "Static marketing website deployed on GitHub Pages with AOS animations, always trying to make good sellers sites.",
    ...
    
    {
      ...
      descripcion: "Scalable, secure, and visually appealing admin dashboard that can manage content, users, media, and analytics efficiently.",
      url: "https://github.com/MariaL2000/Backendelite/",
      stack: ["Python" ,"Django Packages", "PostgreSQL","Django Rest Framework", "Django Jazzmin","Django Colorfield", "Cloudinary"],
...

    {
      ...
      descripcion: "Implementation of a system with Login, Sign in, Logout, a simple Goggle Oauth2 authentication and a CRUD complete for a admin and a econmerce.",
      url: "https://github.com/MariaL2000/Backendelite/",
      stack: ["Python" ,"FastApi", "PostgreSQL","JWT", "Pydantic","SQLAlchemy", "Goggle-auth"],
